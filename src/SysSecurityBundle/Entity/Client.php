 ...
 * @ORM\Entity(repositoryClass="SysSecurityBundle\Repository\ClientRepository")
 */
class Client
{
    /*
    ...
    * city=> user city
    * job_title=> user job
    * organisation=> user organisation or enterprise name
    * status=> user status (0 or 1)
    * category=> user category (academic,enterprise,student)
